...
public final class IssueSpecification {
    ...
    public static Specification<Issue> severity(IssueSeverity severity) {
        if (severity == null) {
            return null;
        }
    ...
    public static Specification<Issue> ownerId(UUID ownerId) {
        if (ownerId == null) {
            return null;
        }
    ...
    public static Specification<Issue> memberOf(UUID userId) {
