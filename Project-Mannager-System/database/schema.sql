-- =============================================================================
-- PM Daily Work Management — SCHEMA THAM CHIẾU (PostgreSQL 16)
-- =============================================================================
-- File này là bản tham chiếu cho Flyway migration `V1__init_schema.sql`
-- (sẽ được tạo chính thức ở Prompt 08 khi có source code Backend).
-- Chi tiết: docs/database/01-data-model.md, 02-data-dictionary.md, 03-index-strategy.md
-- LƯU Ý THỨ TỰ: bảng được FK tham chiếu phải tạo trước (tasks trước action_items,
-- issues trước risks, meetings + tasks trước attachments).
-- =============================================================================
